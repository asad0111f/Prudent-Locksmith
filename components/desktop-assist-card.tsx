...
export function DesktopAssistCard() {
  ...
  return (
    <div className="hidden surface-panel fixed bottom-3 left-3 right-3 z-40 w-auto p-4 backdrop-blur motion-safe:animate-fade-slide sm:block sm:bottom-6 sm:left-auto sm:right-6 sm:w-[360px]">
